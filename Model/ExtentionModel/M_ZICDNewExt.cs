...
namespace Anke.SHManage.Model
{
    ...
    public partial class M_ZICDNew
    {
        ...
        /// <returns></returns>
        public static List<TreeNode> ToTreeNodes(List<M_ZICDNew> listzicd)
        {
            List<TreeNode> listNodes = new List<TreeNode>();
            //生成 树节点时，根据 pid=0的根节点 来生成
            LoadTreeNode(listzicd, listNodes, 0);
            return listNodes;
        }
        ...
        public static void LoadTreeNode(List<M_ZICDNew> listImpression, List<TreeNode> listChildrenNode, int pID)
        {
