...
namespace Anke.AnkeOAService
{
    public class LogUtility
    {
        ...
        /// (一般根据需要修改此变量值即可)
        /// </summary>
        private const string FolderName = "AnkeOAServiceEventLog";
        ...
        static private void WriteLogToApplicationFolderByMonth(string text)
        {
            ...
            string folderPath = string.Format("{0}\\{1}\\Year_{2}", AppConfig.GetConfigString("LogPath"), FolderName, System.DateTime.Now.ToString("yyyy"));
        ...
        {
            if (AppConfig.GetConfigString("LogPath") == null || AppConfig.GetConfigString("LogPath") == "")
                return;
