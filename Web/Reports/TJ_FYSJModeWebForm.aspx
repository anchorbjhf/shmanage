<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TJ_FYSJModeWebForm.aspx.cs" Inherits="Anke.SHManage.Web.Reports.TJ_FYSJModeWebForm" %>
    ...
    <form id="form1" runat="server">
        ...
        <table>
            ...
            <tr>
                ...
                <td>&nbsp;&nbsp;&nbsp; 查询类型：</td>
                <td>
                    <asp:DropDownList ID="DropDownList_Type" runat="server"  Style="width: 150px">                                             
                            <asp:ListItem>分中心</asp:ListItem>
                            <asp:ListItem>分站</asp:ListItem>
                            <asp:ListItem>司机</asp:ListItem>                                               
                    </asp:DropDownList>                   
                </td>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;
